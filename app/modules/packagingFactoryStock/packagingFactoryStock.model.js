...
module.exports = (sequelize, DataTypes) => {
  const PackagingFactoryStock = sequelize.define(
    "PackagingFactoryStock",
    {
      Id: {
    ...
    },
    {
      timestamps: true,
      paranoid: true,
      tableName: "PackagingFactoryStocks",
      hooks: {
        beforeValidate: (stock) => assertNonNegativeUnitValue(stock.unitValue),
